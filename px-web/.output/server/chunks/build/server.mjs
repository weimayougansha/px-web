import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, computed, unref, defineAsyncComponent, defineComponent, h, Suspense, nextTick, mergeProps, provide, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-2cc7a30d>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2cc7a30d"]]);
...
export { _export_sfc as _, isBoolean as a, useGetDerivedNamespace as b, useIdInjection as c, isElement as d, useZIndex as e, useId as f, useRouter as g, useNuxtApp as h, isNumber as i, useRuntimeConfig as j, nuxtLinkDefaults as k, isStringNumber as l, isUndefined as m, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useNamespace as u };
